...
import { FlexContainer, VerticalCard, VerticalCardSkeleton, HorizontalCard, NothingFound } from '../index'
  ...
  return (
    <section className='my-8'>
        ...
        <div className='text-center w-full'>
            <h2 className='font-medium text-4xl'>Latest Posts</h2>
            <p className='text-gray-400 mt-2'>Read the latest posts published by authors</p>
        </div>
